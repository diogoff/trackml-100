...
Apparently, the answer to this question is _yes_, but there are much better approaches to track reconstruction. In other words, the training set does not seem to include all the tracks that may occur in a test experiment.
