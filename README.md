...
Repeat this process for every training particle. (Get the closest test hit on each detector that the particle passes through, then calculate the average distance between particle hits and those test hits.)
