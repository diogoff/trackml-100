...
_Disclaimer:_ I never intended to compete based on such naïve approach. This was just something that I would use as an initial baseline to compare with other algorithms that I would subsequently develop. However, as it often happens in Kaggle competitions, the first idea that comes to mind is the one you will end up with. I call this _love at first sight_.
