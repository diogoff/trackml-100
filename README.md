...
Apparently, the answer to this question is _yes_, but there are way better approaches for track reconstruction. This suggests that the training set does not seem to be representative of all the tracks that may occur in a test experiment.
