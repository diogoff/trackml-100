...
100<sup>th</sup> place?? Why should anyone care? Well, because this solution appeared to be an "odd one" in [post-competition analysis](https://twitter.com/trackmllhc/status/1070339064094736390).
...
Apparently, the answer to this question is _yes_, but the results are not that good (they ranked #100 after all). This seems to indicate that the training set does not include all the tracks that may occur during a test experiment.
...
## Could this approach ever be computationally feasible?
