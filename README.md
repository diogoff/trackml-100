...
Apparently, the answer to this question is _yes_, but there are way better approaches for track reconstruction. This seems to indicate that the training set is not representative of all the tracks that may occur in a test experiment.
