...
To reduce the computational burden and improve the results, we group the particles that go through exactly the same sequence of detectors. These particles are said to have the same _route_.
